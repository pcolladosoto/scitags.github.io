...
| :--- | :--- | :--- |
| **Central Registry** | Maintains the globally authoritative mapping of Virtual Organization (VO) names and specific computational activities to standardized numerical SciTag IDs. | [Scitags API](https://scitags.org/api.json) |
